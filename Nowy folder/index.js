...
const muzyka = document.querySelector("#background-music");
...
function oknaDialogowe(){
    ...
    function gdzieJestem(){
        ...
        div.setAttribute("data-options","Gdzie ja jestem?")
        div.setAttribute("onclick" ,oknaDialogowe())
        div.innerHTML = "Zostales porwany XD"
        lewy.style.backgroundImage = "url('monkey.png')";
        lewy.appendChild(div);
        prawydol.innerHTML =""
